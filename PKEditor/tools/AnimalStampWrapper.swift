    ...
    class Model: AttributeViewController.Model {
        init() {
            var symbolAttributes: [(name: String, image: UIImage)] {
                ...
                let arrowNames = ["arrowshape.left","arrowshape.up",  "arrowshape.right", "arrowshape.down", "arrow.up.and.down.and.arrow.left.and.right"]
                let arrowNames2 = ["arrowshape.left.fill","arrowshape.up.fill",  "arrowshape.right.fill", "arrowshape.down.fill", "arrowshape.left.arrowshape.right.fill"]
                let animalNames = ["dog.fill","pawprint.fill",  "cat.fill", "bird.fill", "fish.fill"] //, "ant.fill"
                let shapeNames = ["circle.fill", "square.fill", "rectangle.fill","triangle.fill","star.fill"
                ]
                let otherNames = ["dog"]
                //, "oval.fill", "oval.portrait.fill",
                let systemNames = arrowNames + arrowNames2 + shapeNames + animalNames + otherNames
